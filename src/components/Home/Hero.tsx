...
export const Hero = () => {
  ...
  return (
    <main>
      ...
      <section className="mt-16 pt-32 pb-[260px] px-20 bg-purple-light text-purple-dark max-md:pt-24 max-md:pb-[200px] max-md:px-10 max-sm:pt-20 max-sm:pb-40 max-sm:px-5 flex items-center justify-center">
        <div className="max-w-screen-xl text-center mx-auto my-0 max-md:px-5 max-md:py-0 flex flex-col items-center justify-center">
